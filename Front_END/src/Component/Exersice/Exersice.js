...
function Exersice() {
  ...
  // Define the missing `landmarks_to_embedding` function
    ...
    return (
          ...
          <div className="yoga-container">
            ...
            <Webcam
             ...
             height="480px"
             ref={webcamRef}
             style={{ borderRadius: '10px' }} // Adjust the '10px' value as per your preference
            />
            <canvas ref={canvasRef} className="overlay-canvas" width="640px" height="480px"></canvas>
            </div>
            ...
            <button className="btn-stop" onClick={stopPose}>
             Stop Pose
            </button>
  ...
  return (
    <div className="container">
        <div className="yoga-container">
          ...
          <div className="menu">
          <DropDown poseList={poseList} currentPose={currentPose} setCurrentPose={setCurrentPose} />
          <button className="btn-start" onClick={startYoga}>
           Start Pose
          </button>
          <button className="btn-start">
           Help
