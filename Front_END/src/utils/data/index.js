export const poseInstructions = {
    ...
    Shoulderstand: [
        'Start by lying down with shoulders on folded blankets, legs bent, and feet on the floor. Walk shoulders underneath the upper back, feeling the chest rise.',
        'Lift hips into bridge pose, press into palms, and extend one leg, then the other, supporting the lower back with your hands.',
        "Keep the neck straight and gaze upward. Lift through the balls of the feet and walk hands further up the back for support.",
        "Ensure hips are over shoulders and legs are perpendicular to the floor. Hold for up to 10 breaths."
    ]
